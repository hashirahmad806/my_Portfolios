...
const contactInfo = [
  { Icon: FiMail,     label: 'Email',    value: 'hashirahmad806@gmail.com',        href: 'mailto:hashirahmad806@gmail.com' },
  { Icon: FiGithub,   label: 'GitHub',   value: 'github.com/hashirahmad806',        href: 'https://github.com/hashirahmad806' },
  { Icon: FiLinkedin, label: 'LinkedIn', value: 'linkedin.com/in/hashir-ahmad',      href: 'https://www.linkedin.com/in/hashir-ahmad-25639031b' },
  { Icon: FiMapPin,   label: 'Location', value: 'Pakistan 🇵🇰 — Open to Remote', href: null },
]
  ...
  return (
    <section id="contact" style={{ padding: '120px 0', background: 'var(--void)' }}>
      <div className="max-w-6xl mx-auto px-6 md:px-12">
        ...
        {/* Header */}
        <div ref={ref} style={{ opacity: visible?1:0, transform: visible?'translateY(0)':'translateY(24px)', transition:'opacity .7s,transform .7s', marginBottom: 56 }}>
        ...
        <div className="grid lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              ...
              {/* Available now pill */}
              <div style={{ marginTop: 8, padding: '14px 18px', borderRadius: 14, border: '1px solid rgba(0,229,160,.15)', background: 'rgba(0,229,160,.04)' }}>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Hi Hashir, I'd love to discuss a project…" required rows={5}
                  ...
                  <motion.button
                    ...
                    whileHover={{ y: -2, boxShadow: '0 12px 32px rgba(201,168,76,.3)' }}
                    whileTap={{ scale: 0.98 }}
                    style={{
                      width: '100%', padding: '16px 24px', borderRadius: 100, border: 'none',
                      background: loading ? 'rgba(201,168,76,.5)' : gold,
                      color: '#080810', fontFamily: "'Cabinet Grotesk',sans-serif",
                  ...
                  >
                    {loading ? (
                      <>
                        <motion.div
                          style={{ width:18, height:18, border:'2.5px solid rgba(8,8,16,.3)', borderTopColor:'#080810', borderRadius:'50%' }}
                          animate={{ rotate: 360 }}
